    ...
    Andrej Sali, email modeller-care AT salilab.org, web https://salilab.org/
...
** DISTRIBUTION:
  ...
  from the MODELLER website (https://salilab.org/modeller/).

  For commercial or governmental licensing of MODELLER, please contact
  BIOVIA, 5005 Wateridge Vista Drive, San Diego, CA 92121, USA,
  email biovia.support@3ds.com, http://www.3dsbiovia.com/.
...
** MODELLER USERS EMAIL LIST:
  ...
  https://salilab.org/modeller/ where you will find detailed instructions 
...
** GRAPHICAL INTERFACE:
  ...
  part of BIOVIA's Discovery Studio interactive molecular modeling program,
  which also contains many other tools for protein modeling and structural
  analysis. This program facilitates preparation of input files for MODELLER
  (e.g. alignment file) as well as an analysis of the results (e.g., an
  evaluation of the models). If you are interested in this program, please
  contact BIOVIA at the address above.
